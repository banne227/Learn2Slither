...
def init_pygame(largeur_pixels, hauteur_pixels):
    ...
    pygame.display.flip()  # affiche tout ce qu'on vient de dessiner (sinon rien n'apparaît)
...
def draw_board(screen, board):
    ...
    for y, ligne in enumerate(grille):
        for x, valeur in enumerate(ligne):
            ...
            pygame.draw.rect(screen, couleur, (x * CELL_SIZE, y * CELL_SIZE, CELL_SIZE, CELL_SIZE))
    pygame.display.flip()
